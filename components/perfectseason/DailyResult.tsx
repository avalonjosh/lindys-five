...
export default function DailyResult({ record, config, streak, played, onPlayFree }: DailyResultProps) {
  ...
  const shareText = buildDailyShare(record, config, 'classic');
    ...
    <div className="flex flex-col gap-4 py-2">
      <div className="rounded-2xl border-2 border-gray-200 bg-white p-4 shadow-xl">
        <div className="flex items-center justify-between">
          <p className="text-[10px] font-bold uppercase tracking-widest text-gray-400">Daily #{record.dayNumber} · Classic</p>
